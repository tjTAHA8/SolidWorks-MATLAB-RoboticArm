...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [-3.2364275023115655e-12 -79.999999999999986 -2.4034220813860789e-12];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [-4.7748471843078732e-12 100.00000000000193 3.0908609005564358e-12];  % mm
smiData.RigidTransform(4).angle = 2.0943951023931953;  % rad
smiData.RigidTransform(4).axis = [0.57735026918962562 -0.57735026918962129 0.57735026918963028];
smiData.RigidTransform(4).ID = "F[Pièce2-1:-:Pièce3-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [0 89.999999999999972 -500];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [92.544787747245124 -145.00000000000949 90.000000000006878];  % mm
smiData.RigidTransform(6).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(6).axis = [1 1.4298544110899529e-31 1.0994362013756514e-15];
smiData.RigidTransform(6).ID = "F[Pièce3-1:-:Pièce4-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(7).translation = [508.73324590163935 0 80.001999999999995];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [-2.1259438653942198e-11 -7.3040240522459499e-11 80.001999999959551];  % mm
smiData.RigidTransform(8).angle = 3.1415926535897913;  % rad
smiData.RigidTransform(8).axis = [-1 -1.0109506194618083e-30 1.1699559860507173e-15];
...
smiData.Solid(1).MoI = [16596.450346774989 47794.890649346598 51730.838217268458];  % kg*mm^2
...
smiData.Solid(2).CoM = [0.029952962614530142 93.215266391773355 31.301976679353771];  % mm
smiData.Solid(2).MoI = [3098037.3277367158 3640209.2661333289 2483282.8949750322];  % kg*mm^2
smiData.Solid(2).PoI = [-299138.57436608017 102.17612353907936 105.30304365616813];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 98.69253991120263;  % kg
smiData.Solid(3).CoM = [0 0 -191.34623167310434];  % mm
smiData.Solid(3).MoI = [4396919.2443982102 4014803.6202799692 782414.81873868452];  % kg*mm^2
smiData.Solid(3).PoI = [0 1.0387061631464264e-09 0.83874153038538835];  % kg*mm^2
smiData.Solid(3).color = [0.52941176470588236 0.5490196078431373 0.5490196078431373];
smiData.Solid(3).opacity = 1;
smiData.Solid(3).ID = "Pièce3*:*Défaut";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 92.83761037555567;  % kg
smiData.Solid(4).CoM = [223.97315353474215 -24.133604852862664 7.2669726483083693e-07];  % mm
smiData.Solid(4).MoI = [583344.1775194814 2493126.2452560882 2744627.9662742335];  % kg*mm^2
smiData.Solid(4).PoI = [-0.0061806817789275739 -0.0019841812566707084 -300542.27650605852];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(5).mass = 113.21446896912043;  % kg
smiData.Solid(5).CoM = [-1.5626065539045298e-07 213.0757453896785 0];  % mm
smiData.Solid(5).MoI = [2194817.1272026617 854021.51770762983 2402882.162125547];  % kg*mm^2
smiData.Solid(5).PoI = [0 0.0098110930683837239 -0.0098945033133028531];  % kg*mm^2
smiData.Solid(5).color = [0.52941176470588236 0.5490196078431373 0.5490196078431373];
smiData.Solid(5).opacity = 1;
smiData.Solid(5).ID = "Pièce2*:*Défaut";
...
smiData.RevoluteJoint(2).Rz.Pos = 34.471012562748832;  % deg
smiData.RevoluteJoint(2).ID = "[Pièce2-1:-:Pièce3-1]";

smiData.RevoluteJoint(3).Rz.Pos = 169.38071470568815;  % deg
smiData.RevoluteJoint(3).ID = "[Pièce3-1:-:Pièce4-1]";

smiData.RevoluteJoint(4).Rz.Pos = 8.0092755952512142;  % deg
